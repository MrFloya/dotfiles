...
sudo mv /home/florian/backups/pacman-database-new.tar.bz2 /home/floya/backups/pacman-database.tar.bz2
...
sudo mv /home/florian/backups/etc-backup-new.tar.bz2 /home/floya/backups/etc-backup.tar.bz2
